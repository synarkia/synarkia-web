...
export const VALUES = [
  { n: "01", value: "Collaborative over competitive", essence: "Synergy & coordination" },
  { n: "02", value: "Win-win approach", essence: "Harmony" },
  { n: "03", value: "Usage value", essence: "Essence & usefulness" },
  { n: "04", value: "Virtuosity", essence: "Mastery & creativity" },
  { n: "05", value: "Authenticity & passion", essence: "Soulfire & integrity" },
  { n: "06", value: "Self-development", essence: "Evolution & transformation" },
  { n: "07", value: "Human development over profit", essence: "Flourishing & empowerment" },
  { n: "08", value: "Frugality, joy, simplicity", essence: "Contentment" },
  { n: "09", value: "Necessity over desire", essence: "Discernment" },
  { n: "10", value: "Organicity & network", essence: "Vitality & scalability" },
  { n: "11", value: "Holistic systemic thinking", essence: "Wholeness" },
  { n: "12", value: "Causes over symptoms", essence: "Generative function" },
] as const;
...
export const ALLIES = [
  ...
  { name: "Yohimbe HCL", kind: "Power plant", note: "Vitality · circulation" },
  { name: "Morning Glory", kind: "Power plant", note: "Threshold seeds" },
  { name: "Rhodiola 5%", kind: "Adaptogen", note: "Altitude resilience" },
  { name: "Voacanga", kind: "Power plant", note: "Deep root medicine" },
  { name: "HeartMath", kind: "Conscious tech", note: "Heart-brain coherence" },
...
export const NETWORK_PILLARS = [
  ...
  },
  {
    ...
    body: "Coordination without coercion. On-chain governance, regenerative trusts, and shared agreements that route value to what creates life.",
  },
  {
    title: "IPFS · Sovereign data",
    body: "Permanence and self-custody. Content-addressed memory so the codex of the alliance cannot be captured, censored, or erased.",
  },
] as const;
