    ...
    <section id="contact" className="relative py-28 md:py-40 overflow-hidden">
      ...
      <div className="mx-auto w-full max-w-[1200px] px-5 sm:px-8 relative z-10">
        <div className="text-center mb-16 md:mb-20">
          <span className="kl-eyebrow">Get in touch</span>
          <h2 className="kl-h1 mt-6 mb-6">Let&apos;s build something rare.</h2>
          <p className="kl-body max-w-xl mx-auto">
            Ready to align vision with infrastructure? The quickest way forward is a discovery call —
            thirty minutes, no pitch, you leave with a direction.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-8 items-start">
          ...
          <div className="space-y-6">
            <div className="kl-card p-8 md:p-10">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h3 className="kl-h3 text-light">Book a discovery call</h3>
              </div>
              <p className="kl-body mb-8">
                The fastest way to start. We discuss your needs and see if we&apos;re a fit —
            ...
            <div>
              <p className="kl-eyebrow mb-4">Or reach out directly</p>
              <div className="space-y-3">
                <a href={`mailto:${EMAIL}`} className="kl-card flex items-center gap-4 p-5 group">
                  ...
                  <span>
                    <span className="kl-eyebrow block mb-1">Email</span>
                ...
                <a href="https://www.linkedin.com" target="_blank" rel="noopener noreferrer" className="kl-card flex items-center gap-4 p-5 group">
                  ...
                  <span>
                    <span className="kl-eyebrow block mb-1">LinkedIn</span>
                    <span className="kl-body text-light">Connect on LinkedIn</span>
                  </span>
                </a>
              </div>
            </div>
          ...
          {/* RIGHT — message form */}
          <div className="kl-card p-8 md:p-10">
            <h3 className="kl-h3 text-light mb-2">Send a message</h3>
            <p className="kl-body-sm mb-8">Tell us what you&apos;re building. We respond within 24–48 hours.</p>
            ...
            {sent ? (
              <div className="flex flex-col items-center justify-center text-center py-12">
                ...
                <p className="kl-h3 text-light mb-2">Your message is ready.</p>
                <p className="kl-body-sm max-w-xs">
                  We opened your email client to send it to {EMAIL}. Prefer a call?{" "}
                  <a href={BOOKING_URL} target="_blank" rel="noopener noreferrer" className="text-light underline underline-offset-4">Book one here.</a>
                </p>
              </div>
            ) : (
              <form onSubmit={onSubmit} className="space-y-5">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <Field label="Name">
                    <input required value={form.name} onChange={update("name")} placeholder="Your name" className="kl-field w-full px-4 py-3 text-[15px]" />
                  </Field>
                  <Field label="Email">
                    <input required type="email" value={form.email} onChange={update("email")} placeholder="you@company.com" className="kl-field w-full px-4 py-3 text-[15px]" />
                  </Field>
                </div>
                <Field label="Company">
                  <input value={form.company} onChange={update("company")} placeholder="Your company name" className="kl-field w-full px-4 py-3 text-[15px]" />
                </Field>
                ...
                <Field label="Message">
                  <textarea required rows={4} value={form.message} onChange={update("message")} placeholder="Tell us about your project and goals…" className="kl-field w-full px-4 py-3 text-[15px] resize-none" />
                </Field>
